...
const vlamax = (0.02049 / (workload / bodyMass)) * vo2max * (bmi / 22) * (1 + 0.000025 * age - 0.0000001 * bodyMass);
```

March 25th 2023 - updated the Vlamax calculation so it is more accuarte. Also added BMI calcualation.
